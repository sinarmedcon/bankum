...
<div class="jumbotron jumbotron-fluid text-white text-center" style="background:linear-gradient(40deg, #5327F2, #0511F2, #030A8C, #010440, #0D0D0D)">
    <div class="container">
        ...
        <h1 class="display-4">Yuk Gabung Sebagai Mitra Bankum</h1>
        <p class="lead">Jadilah salah satu mitra advokat kami. Anda bisa mendaftarkan diri Anda dan LBH/OBH/LKBH tempat Anda bekerja menjadi salah satu mitra kami.</p>
        <br>
            <br>
        <br>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <button class="btn btn-danger btn-block btn-lg mt-1 mb-5" data-toggle="modal" data-target="#lbh">Gabung</button>
